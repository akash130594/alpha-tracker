...
class ProjectResume extends SJPanelBase implements ShouldQueue
{
    public function resumeProject(SourceAPIEvents $sourceAPIEvent)
    {
        ...
        foreach ($project_surveys as $survey) {
            ...
            if($response){
                ...
                $survey->save();
                Session::flash('flash_success', 'SJ Panel Resume #'.$response->Project->code);

            }else{
                Session::flash('flash_danger', 'SJ Panel Resume Error Occured');
            }
