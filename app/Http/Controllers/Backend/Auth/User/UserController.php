...
use App\Http\Requests\Backend\Employee\AddRequest;
use App\Http\Requests\Backend\Employee\EditRequest;
...
class UserController extends Controller
{
    ...
    {
        $allEmployees = $this->userRepository->getAllEmployees();
        return view('backend.auth.employee.index')
        ->with('employees', $allEmployees);
    }
    ...
    public function updateEmployee(EditRequest $request, $id)
    {
        $data = $request->except(['_token']);
        $employee = $this->userRepository->getEmployeeByID($id);
        $updatedEmployee = $this->userRepository->updateEmplyee($data, $id);
        if(!$updatedEmployee){
            return redirect()->back()
            ->withErrors("Something Went Wrong!!");
        }
