<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @auth
                <li class="nav-item"><a href="{{route('internal.dashboard')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.user.dashboard')) }}">@lang('navs.frontend.dashboard')</a></li>
            @endauth
