        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <strong>
                        <i class="fas fa-tachometer-alt"></i> Study Types
                    </strong>
                    <div class="float-right">
                        <a href="{{route('internal.general.study_type.create')}}" class="btn btn-primary">Create Study Types</a>
                    </div>
                </div><!--card-header-->
    ...
    <script>
        $(document).ready(function() {
            $('#source-show').DataTable({
                serverSide: true,
                ajax: "{{ route('internal.general.study_type.datatable') }}",
                columns: [
                    { name: 'id' },
                    { name: 'code' },
                    { name: 'name' },
