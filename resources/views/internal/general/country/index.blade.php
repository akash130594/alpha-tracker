        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <strong>
                        <i class="fas fa-tachometer-alt"></i> Countries
                    </strong>
                    <div class="float-right">
                        <a href="{{route('internal.general.country.create')}}" class="btn btn-primary">Create Country</a>
                    </div>
                </div><!--card-header-->
    ...
    <script>
        $(document).ready(function() {
            $('#source-show').DataTable({
                serverSide: true,
                ajax: "{{ route('internal.general.country.datatable') }}",
                columns: [
                    { name: 'id' },
                    { name: 'country_code' },
                    { name: 'name' },
