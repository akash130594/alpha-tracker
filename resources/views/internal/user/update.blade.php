        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <strong>
                        <i class="fas fa-tachometer-alt"></i> Update Profile
                    </strong>
                </div><!--card-header-->
                                ...
                                <div class="col-sm-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            {!!Form::text('first name', 'First Name', $user_info->first_name)->readonly(false)!!}
                                            {!!Form::text('last name', 'Last Name', $user_info->last_name)->readonly(false)!!}
                                            {!!Form::text('email', 'Email Id', $user_info->email)->readonly()!!}
                                            {!!Form::submit("Update")!!}
                                            {!!Form::close()!!}
                                        </div>
                                    </div>
