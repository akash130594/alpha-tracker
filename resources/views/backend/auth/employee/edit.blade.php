...
@section('content')
    {{ html()->form('POST', route('admin.auth.employee.update',$employee->id))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            {{ html()->label(__('Employee Employee Id'))->class('col-md-2 form-control-label')->for('empid') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                            <input class="form-control" type="text" name="doj" value="{{$employee->doj}}" id="doj" placeholder="Enter Date of Joining" required="" autofocus="">
                            </div><!--col-->
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{$employee->dob}}" name="dob" id="dob" placeholder="Enter Date of Birth" required="" autofocus="">
                            </div><!--col-->
                        </div>
                        ...
                        <div class="form-group">
                            <div class="radio">
                              <label>
                                <input type="radio" @if($employee->status == 0) checked @endif name="status" id="inactive" value="0">
                                Inactive
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" @if($employee->status == 1) checked @endif name="status" id="active" value="1">
                                Active
                              </label>
                            </div>
                          </div>
