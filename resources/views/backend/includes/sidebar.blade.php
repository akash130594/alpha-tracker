<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @can('access user management')
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern('admin/auth/employee*'), 'open') }}">
                    <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/auth*')) }}" href="#">
                        <i class="nav-icon icon-user"></i> @lang('Employee Management')
                    </a>

                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/employee*')) }}" href="{{ route('admin.auth.employee.list') }}">
                                @lang('All Employees')
                            </a>
                        </li>
                    </ul>
