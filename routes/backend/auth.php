...
Route::group([
    ...
    Route::group(['namespace' => 'Employee'], function () {
        Route::group(['prefix' => 'employee'], function(){
            Route::get('list',[UserController::class, 'listEmployee'])->name('employee.list');
            Route::get('add',[UserController::class, 'addEmployee'])->name('employee.add');
            Route::post('post',[UserController::class, 'postEmployee'])->name('employee.post');
            Route::get('edit/{id}',[UserController::class, 'editEmployee'])->name('employee.edit');
            Route::post('update/{id}',[UserController::class, 'updateEmployee'])->name('employee.update');
        });
    });
});
