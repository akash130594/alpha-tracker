...
Breadcrumbs::for('internal.client.index', function ($trail) {
    $trail->parent('internal.dashboard');
    $trail->push(__('All Clients'), route('internal.client.index'));
});
Breadcrumbs::for('internal.client.edit.show', function ($trail,$id) {
    $trail->parent('internal.client.index');
    $trail->push(__('Edit Client #'.$id), route('internal.client.edit.show',$id));
});
